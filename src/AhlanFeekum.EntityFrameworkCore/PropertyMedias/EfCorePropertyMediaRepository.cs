...
{
    public abstract class EfCorePropertyMediaRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, PropertyMedia, Guid>
    {
        public EfCorePropertyMediaRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
