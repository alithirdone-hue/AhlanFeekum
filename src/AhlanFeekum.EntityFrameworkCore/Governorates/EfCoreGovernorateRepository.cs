...
{
    public abstract class EfCoreGovernorateRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, Governorate, Guid>
    {
        public EfCoreGovernorateRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
