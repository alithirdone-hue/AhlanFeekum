...
{
    public abstract class EfCorePropertyEvaluationRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, PropertyEvaluation, Guid>
    {
        public EfCorePropertyEvaluationRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
