...
{
    public abstract class EfCoreVerificationCodeRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, VerificationCode, Guid>
    {
        public EfCoreVerificationCodeRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
