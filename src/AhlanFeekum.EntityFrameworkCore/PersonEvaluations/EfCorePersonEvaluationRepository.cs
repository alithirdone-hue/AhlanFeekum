...
{
    public abstract class EfCorePersonEvaluationRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, PersonEvaluation, Guid>
    {
        public EfCorePersonEvaluationRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
