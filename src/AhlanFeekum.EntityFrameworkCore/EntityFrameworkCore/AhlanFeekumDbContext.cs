    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        if (builder.IsHostDatabase())
        {
            builder.Entity<UserPayment>(b =>
            {
                ...
                b.Property(x => x.Currency).HasColumnName(nameof(UserPayment.Currency));
                ...
                b.Property(x => x.StripPaymentId).HasColumnName(nameof(UserPayment.StripPaymentId));
                b.Property(x => x.StripClientSecret).HasColumnName(nameof(UserPayment.StripClientSecret));
                b.Property(x => x.Created).HasColumnName(nameof(UserPayment.Created));
