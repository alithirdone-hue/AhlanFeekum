...
{
    public abstract class EfCoreFavoritePropertyRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, FavoriteProperty, Guid>
    {
        public EfCoreFavoritePropertyRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
