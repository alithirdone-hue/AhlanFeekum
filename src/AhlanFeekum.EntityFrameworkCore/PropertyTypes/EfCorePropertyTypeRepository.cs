...
{
    public abstract class EfCorePropertyTypeRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, PropertyType, Guid>
    {
        public EfCorePropertyTypeRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
