...
{
    public abstract class EfCoreUserProfileRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, UserProfile, Guid>
    {
        public EfCoreUserProfileRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
