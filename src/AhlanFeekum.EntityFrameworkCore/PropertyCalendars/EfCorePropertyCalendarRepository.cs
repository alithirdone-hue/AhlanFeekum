...
{
    public abstract class EfCorePropertyCalendarRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, PropertyCalendar, Guid>
    {
        public EfCorePropertyCalendarRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
