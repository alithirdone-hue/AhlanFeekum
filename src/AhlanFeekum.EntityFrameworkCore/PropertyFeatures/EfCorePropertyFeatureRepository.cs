...
{
    public abstract class EfCorePropertyFeatureRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, PropertyFeature, Guid>
    {
        public EfCorePropertyFeatureRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
