...
{
    public abstract class EfCoreSpecialAdvertismentRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, SpecialAdvertisment, Guid>
    {
        public EfCoreSpecialAdvertismentRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
