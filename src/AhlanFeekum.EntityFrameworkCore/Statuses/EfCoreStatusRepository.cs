...
{
    public abstract class EfCoreStatusRepositoryBase : EfCoreRepository<AhlanFeekumDbContext, Status, Guid>
    {
        public EfCoreStatusRepositoryBase(IDbContextProvider<AhlanFeekumDbContext> dbContextProvider)
        ...
        public virtual async Task<List<Status>> GetListAsync(
            string? filterText = null,
            string? name = null,
            int? orderMin = null,
            int? orderMax = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? StatusConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<Status> ApplyFilter(
