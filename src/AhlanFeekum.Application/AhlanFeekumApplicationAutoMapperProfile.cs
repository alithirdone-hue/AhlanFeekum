...
public class AhlanFeekumApplicationAutoMapperProfile : Profile
{
    public AhlanFeekumApplicationAutoMapperProfile()
    {
        ...
        CreateMap<ReservationWithNavigationProperties, ReservationMobileDto>()
              ...
              .ForMember(dest => dest.ReservationPaymentMethod, opt => opt.MapFrom(src => src.Reservation.ReservationPaymentMethod))
              .ForMember(dest => dest.ReservationPaymentMethodAsString, opt => opt.MapFrom(src => src.Reservation.ReservationPaymentMethod != null ? src.Reservation.ReservationPaymentMethod.ToString() : ""))
              .ForMember(dest => dest.IsPaid, opt => opt.MapFrom(src => src.Reservation.IsPaid))
              .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Reservation.Description))
