...
namespace AhlanFeekum.UserProfiles
{
    ...
    [Authorize(AhlanFeekumPermissions.UserProfiles.Default)]
    public abstract class UserProfilesAppServiceBase : AhlanFeekumAppService
    {
        ...
        [Authorize(AhlanFeekumPermissions.UserProfiles.Create)]
        ...
        [Authorize(AhlanFeekumPermissions.UserProfiles.Edit)]
