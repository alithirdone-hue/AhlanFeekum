...
namespace AhlanFeekum.OnlyForYouSections
{
    ...
    [Authorize(AhlanFeekumPermissions.OnlyForYouSections.Default)]
    public abstract class OnlyForYouSectionsAppServiceBase : AhlanFeekumAppService
    {
        ...
        [Authorize(AhlanFeekumPermissions.OnlyForYouSections.Create)]
        ...
        [Authorize(AhlanFeekumPermissions.OnlyForYouSections.Edit)]
