...
namespace AhlanFeekum.PropertyEvaluations
{
    ...
    [Authorize(AhlanFeekumPermissions.PropertyEvaluations.Default)]
    public abstract class PropertyEvaluationsAppServiceBase : AhlanFeekumAppService
    {
        ...
        [Authorize(AhlanFeekumPermissions.PropertyEvaluations.Delete)]
        ...
        [Authorize(AhlanFeekumPermissions.PropertyEvaluations.Edit)]
