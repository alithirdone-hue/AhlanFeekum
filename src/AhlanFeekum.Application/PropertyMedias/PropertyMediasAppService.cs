...
namespace AhlanFeekum.PropertyMedias
{
    ...
    [Authorize(AhlanFeekumPermissions.PropertyMedias.Default)]
    public abstract class PropertyMediasAppServiceBase : AhlanFeekumAppService
    {
        ...
        public PropertyMediasAppServiceBase(IPropertyMediaRepository propertyMediaRepository, PropertyMediaManager propertyMediaManager, IDistributedCache<PropertyMediaDownloadTokenCacheItem, string> downloadTokenCache, IRepository<AhlanFeekum.SiteProperties.SiteProperty, Guid> sitePropertyRepository)
        {
        ...
        [Authorize(AhlanFeekumPermissions.PropertyMedias.Delete)]
        public virtual async Task DeleteAsync(Guid id)
        {
            await _propertyMediaRepository.DeleteAsync(id);
        }

        [Authorize(AhlanFeekumPermissions.PropertyMedias.Create)]
