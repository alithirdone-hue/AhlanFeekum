...
namespace AhlanFeekum.VerificationCodes
{
    ...
    [Authorize(AhlanFeekumPermissions.VerificationCodes.Default)]
    public abstract class VerificationCodesAppServiceBase : AhlanFeekumAppService
    {
        ...
        [Authorize(AhlanFeekumPermissions.VerificationCodes.Delete)]
        public virtual async Task DeleteAsync(Guid id)
        {
            await _verificationCodeRepository.DeleteAsync(id);
        }

        [Authorize(AhlanFeekumPermissions.VerificationCodes.Create)]
        ...
        [Authorize(AhlanFeekumPermissions.VerificationCodes.Edit)]
