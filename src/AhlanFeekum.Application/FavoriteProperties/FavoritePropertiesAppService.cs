...
namespace AhlanFeekum.FavoriteProperties
{
    ...
    [Authorize(AhlanFeekumPermissions.FavoriteProperties.Default)]
    public abstract class FavoritePropertiesAppServiceBase : AhlanFeekumAppService
    {
        ...
        public FavoritePropertiesAppServiceBase(IFavoritePropertyRepository favoritePropertyRepository, FavoritePropertyManager favoritePropertyManager, IDistributedCache<FavoritePropertyDownloadTokenCacheItem, string> downloadTokenCache, IRepository<AhlanFeekum.UserProfiles.UserProfile, Guid> userProfileRepository, IRepository<AhlanFeekum.SiteProperties.SiteProperty, Guid> sitePropertyRepository)
        {
        ...
        [Authorize(AhlanFeekumPermissions.FavoriteProperties.Edit)]
