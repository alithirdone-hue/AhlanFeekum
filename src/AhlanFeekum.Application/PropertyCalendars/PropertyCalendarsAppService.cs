...
namespace AhlanFeekum.PropertyCalendars
{
    ...
    [Authorize(AhlanFeekumPermissions.PropertyCalendars.Default)]
    public abstract class PropertyCalendarsAppServiceBase : AhlanFeekumAppService
    {
        ...
        public PropertyCalendarsAppServiceBase(IPropertyCalendarRepository propertyCalendarRepository, PropertyCalendarManager propertyCalendarManager, IDistributedCache<PropertyCalendarDownloadTokenCacheItem, string> downloadTokenCache, IRepository<AhlanFeekum.SiteProperties.SiteProperty, Guid> sitePropertyRepository)
        {
        ...
        [Authorize(AhlanFeekumPermissions.PropertyCalendars.Delete)]
