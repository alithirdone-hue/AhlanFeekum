...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class PropertyMedias
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.PropertyMedias.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreatePropertyMedia = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.PropertyMedias.Create);
            CanEditPropertyMedia = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyMedias.Edit);
            CanDeletePropertyMedia = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyMedias.Delete);
