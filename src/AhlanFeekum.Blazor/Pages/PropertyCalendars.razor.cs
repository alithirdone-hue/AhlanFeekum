...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class PropertyCalendars
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.PropertyCalendars.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreatePropertyCalendar = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.PropertyCalendars.Create);
            CanEditPropertyCalendar = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyCalendars.Edit);
            CanDeletePropertyCalendar = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyCalendars.Delete);
