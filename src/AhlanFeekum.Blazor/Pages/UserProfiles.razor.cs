...
private IReadOnlyList<LookupDto<Guid>> IdentityUsersCollection { get; set; } = new List<LookupDto<Guid>>();
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.UserProfiles.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateUserProfile = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.UserProfiles.Create);
            CanEditUserProfile = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.UserProfiles.Edit);
            CanDeleteUserProfile = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.UserProfiles.Delete);
