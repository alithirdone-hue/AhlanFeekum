...
private IReadOnlyList<LookupDto<Guid>> SitePropertiesCollection { get; set; } = new List<LookupDto<Guid>>();
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.FavoriteProperties.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateFavoriteProperty = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.FavoriteProperties.Create);
            CanEditFavoriteProperty = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.FavoriteProperties.Edit);
            CanDeleteFavoriteProperty = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.FavoriteProperties.Delete);
