...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class PersonEvaluations
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.PersonEvaluations.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreatePersonEvaluation = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.PersonEvaluations.Create);
            CanEditPersonEvaluation = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PersonEvaluations.Edit);
            CanDeletePersonEvaluation = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PersonEvaluations.Delete);
