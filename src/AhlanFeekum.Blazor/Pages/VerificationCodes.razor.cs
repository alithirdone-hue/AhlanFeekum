...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class VerificationCodes
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.VerificationCodes.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateVerificationCode = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.VerificationCodes.Create);
            CanEditVerificationCode = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.VerificationCodes.Edit);
            CanDeleteVerificationCode = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.VerificationCodes.Delete);
