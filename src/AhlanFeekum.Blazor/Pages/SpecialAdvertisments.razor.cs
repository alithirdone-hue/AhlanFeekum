...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class SpecialAdvertisments
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.SpecialAdvertisments.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateSpecialAdvertisment = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.SpecialAdvertisments.Create);
            CanEditSpecialAdvertisment = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.SpecialAdvertisments.Edit);
            CanDeleteSpecialAdvertisment = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.SpecialAdvertisments.Delete);
