...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class Governorates
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.Governorates.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateGovernorate = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.Governorates.Create);
            CanEditGovernorate = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.Governorates.Edit);
            CanDeleteGovernorate = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.Governorates.Delete);
