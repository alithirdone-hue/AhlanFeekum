...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class PropertyTypes
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.PropertyTypes.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreatePropertyType = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.PropertyTypes.Create);
            CanEditPropertyType = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyTypes.Edit);
            CanDeletePropertyType = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyTypes.Delete);
