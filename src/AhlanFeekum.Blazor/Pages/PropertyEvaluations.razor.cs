...
private IReadOnlyList<LookupDto<Guid>> SitePropertiesCollection { get; set; } = new List<LookupDto<Guid>>();
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.PropertyEvaluations.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreatePropertyEvaluation = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.PropertyEvaluations.Create);
            CanEditPropertyEvaluation = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyEvaluations.Edit);
            CanDeletePropertyEvaluation = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyEvaluations.Delete);
