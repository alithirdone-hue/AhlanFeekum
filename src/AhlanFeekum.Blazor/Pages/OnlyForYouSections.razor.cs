...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class OnlyForYouSections
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.OnlyForYouSections.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreateOnlyForYouSection = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.OnlyForYouSections.Create);
            CanEditOnlyForYouSection = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.OnlyForYouSections.Edit);
            CanDeleteOnlyForYouSection = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.OnlyForYouSections.Delete);
