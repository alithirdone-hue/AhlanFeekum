...
namespace AhlanFeekum.Blazor.Pages
{
    public partial class PropertyFeatures
    {
        ...
        protected virtual ValueTask SetToolbarItemsAsync()
        {
            ...
            }, IconName.Add, requiredPolicyName: AhlanFeekumPermissions.PropertyFeatures.Create);
        ...
        private async Task SetPermissionsAsync()
        {
            CanCreatePropertyFeature = await AuthorizationService
                .IsGrantedAsync(AhlanFeekumPermissions.PropertyFeatures.Create);
            CanEditPropertyFeature = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyFeatures.Edit);
            CanDeletePropertyFeature = await AuthorizationService
                            .IsGrantedAsync(AhlanFeekumPermissions.PropertyFeatures.Delete);
